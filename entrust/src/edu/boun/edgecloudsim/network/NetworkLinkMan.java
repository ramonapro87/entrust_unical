 ...
 */
public class NetworkLinkMan extends NetworkLink {

	public NetworkLinkMan(Host src, Host dst, SimManager simulationManager, NetworkLinkTypes type) {
		super(src, dst, simulationManager, type);
		setBandwidth(SimSettings.getInstance().getManBandwidth());
		setDelay(SimSettings.getInstance().getManDelay()); 
		setEnergyModel(new DefaultEnergyNetworkModel(SimSettings.getInstance().getManWattHourPerBit(), this));
	}
