...
public class NetworkLinkCellularUp extends NetworkLinkCellular {
	...
	public NetworkLinkCellularUp(Host src, Host dst, SimManager simulationManager, NetworkLinkTypes type) {
		super(src, dst, simulationManager, type);
		double energyConsumption = SimSettings.getInstance().getCellularDeviceTransmissionWattHourPerBit()
				+ SimSettings.getInstance().getCellularBaseStationWattHourPerBitUpLink();
