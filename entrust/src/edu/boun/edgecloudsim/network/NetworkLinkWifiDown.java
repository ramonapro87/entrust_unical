 ...
 * A WiFi network link.
 */
public class NetworkLinkWifiDown extends NetworkLinkWifi {

	public NetworkLinkWifiDown(Host src, Host dst, SimManager simulationManager,
			NetworkLinkTypes type) {
		super(src, dst, simulationManager, type);
		double energyConsumption = SimSettings.getInstance().getWifiAccessPointTransmissionWattHourPerBit()
				+ SimSettings.getInstance().getWifiDeviceReceptionWattHourPerBit();
